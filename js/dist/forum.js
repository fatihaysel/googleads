module.exports =
    ...
    /******/ ({
        ...
        /***/ "./src/forum/addAdBetweenDiscuss.js":
        /*!******************************************!*\
          !*** ./src/forum/addAdBetweenDiscuss.js ***!
          \******************************************/
        /*! exports provided: default */
        /***/ (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */ __webpack_exports__["default"] = (function () {
                Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionList__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'view', function (component) {
                    var advertisement = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('flagrow.ads.between-discuss');

                    if (advertisement && component.children.length) {
                        var start = 0;
                        var between = 7;
                        var discuss = component.children;

                        if (discuss.length === 2) {
                            var sorular = discuss[0].children;
                            sorular.forEach(function (post, i) {
                                if (i >= start && (i - start) % between === 0 && i < sorular.length - 1) {
                                    post.children.push(m('li.data-id=25252525', m('div.DiscussionListItem', m('div.betweendiscuss', m.trust(advertisement)))));
                                }
                            });
                        }

                        if (discuss.length === 3) {
                            var _sorular = discuss[1].children;

                            _sorular.forEach(function (post, i) {
                                if (i >= start && (i - start) % between === 0 && i < _sorular.length - 1) {
                                    post.children.push(m('li.data-id=25252525', m('div.DiscussionListItem', m('div.betweendiscuss', m.trust(advertisement)))));
                                }
                            });
                        }
        ...
        /***/ (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */ __webpack_exports__["default"] = (function () {
                Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_Page__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'config', function () {
                    if ($(".adsbygoogle").length && window.adsbygoogle) {
                        if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.header_ad_active !== true) {
                            try {
                            ...
                            flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.header_ad_active = true;
                        }

                        if (!flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.ads_index) {
                            flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.ads_index = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.history.stack.length;
                        } else if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.ads_index !== flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.history.stack.length) {
                            flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.ads_index = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.history.stack.length;
                ...
                Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_PostStream__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'config', function () {
                    if ($(".adsbygoogle").length && window.adsbygoogle) {
                        try {
                            (adsbygoogle = window.adsbygoogle || []).push({});
                        } catch (_unused2) {
                ...
                Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'config', function () {
                    if ($(".adsbygoogle").length && window.adsbygoogle) {
                        if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.index_ad_active !== true && window.adsbygoogle.loaded !== true) {
                            try {
                                (adsbygoogle = window.adsbygoogle || []).push({});
                            } catch (_unused3) {
                                return;
                            ...
                            flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.index_ad_active = true;
                        }
                    }
                });
            });
        ...
        /***/ (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _addAdBetweenDiscuss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addAdBetweenDiscuss */ "./src/forum/addAdBetweenDiscuss.js");
            /* harmony import */ var _addAdsenseCompat__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./addAdsenseCompat */ "./src/forum/addAdsenseCompat.js");
            /* harmony import */ var _components_AdPostType__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/AdPostType */ "./src/forum/components/AdPostType.js");
            ...
            flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('flagrow-ads', function (app) {
                app.postComponents.ad = _components_AdPostType__WEBPACK_IMPORTED_MODULE_6__["default"];
                ...
                Object(_addAdBetweenDiscuss__WEBPACK_IMPORTED_MODULE_4__["default"])();
                Object(_addAdsenseCompat__WEBPACK_IMPORTED_MODULE_5__["default"])();
            });
